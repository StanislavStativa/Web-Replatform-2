...
import { RegisterPersonalUserFieldProps } from './RegisterPersonalUser.types';
import { RichText } from '@sitecore-jss/sitecore-jss-nextjs';

const RegisterPersonalUserImage: React.FC<RegisterPersonalUserFieldProps> = (props) => {
  ...
  return (
    <div className="flex flex-col h-full justify-center border border-border-gray rounded-t-10 rounded-lg bg-white ">
      ...
      <div className="flex justify-center  h-full px-8 lg:px-14 py-17  pb-8 ">
        <RichText
...
export default RegisterPersonalUserImage;
