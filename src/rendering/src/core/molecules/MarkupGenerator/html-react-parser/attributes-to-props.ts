...
export default function attributesToProps(attributes: Attributes = {}, nodeName?: string): Props {
  ...
  for (const attributeName in attributes) {
    ...
    if (attributeNameLowerCased && attributeNameLowerCased in manualPropMap) {
      props[manualPropMap[attributeNameLowerCased as keyof typeof manualPropMap]] = attributeValue;
      continue;
    }
